...
<div class="tab-pane fade active show" id="tab1" role="tabpanel" aria-labelledby="tb-tab1">
     <div id="myCarousel" class="carousel slide">
        ...
        <ul class="carousel-indicators list-inline mx-auto px-2">
          <li class="list-inline-item active"> <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#myCarousel"> <img src="../assets/images/galeries/faux_plafonds/fp_1.jpg" class="img-fluid"> </a> </li>
          <li class="list-inline-item"> <a id="carousel-selector-1" data-slide-to="1" data-target="#myCarousel"> <img src="../assets/images/galeries/faux_plafonds/fp_2.jpg" class="img-fluid one"> </a> </li>
          <li class="list-inline-item"> <a id="carousel-selector-2" data-slide-to="2" data-target="#myCarousel"> <img src="../assets/images/galeries/faux_plafonds/fp_3.jpg" class="img-fluid two"> </a> </li>
          <li class="list-inline-item"> <a id="carousel-selector-3" data-slide-to="3" data-target="#myCarousel"> <img src="../assets/images/galeries/faux_plafonds/fp_4.jpg" class="img-fluid three"> </a> </li>
        </ul>
      </div>
  <!-- caption slideshow -->
...
<!-- TAB 2 starts below  -->
  <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tb-tab2">
      <div id="myCarousel1" class="carousel slide">
        ...
        <!-- main slider carousel nav controls -->
        <ul class="carousel-indicators list-inline mx-auto px-2">
          <li class="list-inline-item active"> <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#myCarousel1"> <img src="../assets/images/galeries/faux_plafonds/fp_5.jpg" class="img-fluid"> </a> </li>
          <li class="list-inline-item"> <a id="carousel-selector-1" data-slide-to="1" data-target="#myCarousel1"> <img src="../assets/images/galeries/faux_plafonds/fp_6.jpg" class="img-fluid one"> </a> </li>
          <li class="list-inline-item"> <a id="carousel-selector-2" data-slide-to="2" data-target="#myCarousel1"> <img src="../assets/images/galeries/faux_plafonds/fp_7.jpg" class="img-fluid two"> </a> </li>
        </ul>
      </div>
  <!-- caption slideshow -->
      <div class="main-text mx-auto">
  ...
  <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tb-tab3">
      <div id="myCarousel2" class="carousel slide">
        ...
        <div class="carousel-inner text-center pb-4">
          ...
          <div class="carousel-item" data-slide-number="1"> <img src="../assets/images/galeries/faux_plafonds/fp_9.jpg" width="600" class="img-fluid"> </div>
        ...
        <!-- main slider carousel nav controls -->
        <ul class="carousel-indicators list-inline mx-auto px-2">
          <li class="list-inline-item active"><a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#myCarousel2"><img src="../assets/images/galeries/faux_plafonds/fp_8.jpg" class="img-fluid"> </a> </li>
          <li class="list-inline-item"> <a id="carousel-selector-1" data-slide-to="1" data-target="#myCarousel2"> <img src="../assets/images/galeries/faux_plafonds/fp_9.jpg" class="img-fluid one"> </a> </li>
          </li>
        </ul>
      </div>
  <!-- caption slideshow -->
