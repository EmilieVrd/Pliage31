...
<div class="container-fluid">
  <div id="carouselExampleIndicators" class="carousel slide mt-lg-5 shadow-lg" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active"> <img class="d-block w-100" src="https://www.pliage31.com/s/cc_images/cache_72737389.jpg" alt="First slide"> </div>
      <div class="carousel-item"> <img class="d-block w-100" src="https://www.pliage31.com/s/cc_images/cache_72737391.jpg" alt="Second slide"> </div>
      <div class="carousel-item"> <img class="d-block w-100" src="https://www.pliage31.com/s/cc_images/cache_72737392.jpg" alt="Third slide"> </div>
    </div>
      ...
      <div class="card-deck">
        ...
        <div class="news-card mx-4"> <a href="#" class="news-card__card-link"></a> <img src="https://www.pliage31.com/s/cc_images/cache_29561739.jpg?t=1476981127" alt="photo couvertine alu" class="news-card__image">
          <div class="news-card__text-wrapper">
            ...
            <div class="news-card__details-wrapper">
				<p class="news-card__excerpt">Perforées, larmées.. galva ou inox </br></br></br></p>
              <a class="btn btn-primary btn-lg" href="#" role="button">Liste des autres matières en stock</a> </div>
          </div>
        </div>		  
      </div>
...
<footer class="mt-5">
  	<div class="container-fluid">
		<div class="row text-center">
			<div class="col-lg-12"><div class="card-header"><img src="assets/images/logo/logo_2 (2).png"</div></div>
				<p><strong>Pliage 31</strong> 2 imp. Raymond Loewy 31140 Aucamville Téléphone : 05 62 10 26 22 Fax :05.62.10.54.20 Email : contact@pliage31.com</p>
		</div>
	</div>
</footer>
<!--________________________________________ /FOOTER ___________________________________________--> 
