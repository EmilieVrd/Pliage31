...
<header>
  <nav class="navbar navbar-expand-lg bg-light">
    <a class="navbar-brand" href="index.php"><img class="logo" src="assets/images/logo/logo.png" alt="logo"></a>
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown"> <a class="nav-link" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Notre Savoir-Faire </a>
          <div class="dropdown-menu">
  			<a class="dropdown-item" href="pages/galerie_couvertine.php">Couvertines et Anti-gouttes</a>
  			...
  			<a class="dropdown-item" href="pages/galerie_inox_cuisine_autre.php">Inox Pour Les Cuisines Et Autres</a> </div>
        </li>
...
Fax :05.62.10.54.20
Email : contact@pliage31.com
</p>
© Pliage31 | <a href="pages/mentionslegales.php">Mentions légales</a>
